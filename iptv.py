...
CHANNEL_CATEGORIES = {
    ...
    "卫视频道": ['山东卫视', '浙江卫视', '江苏卫视', '东方卫视', '深圳卫视', '北京卫视', '广东卫视', '广西卫视', '东南卫视', '海南卫视',
                 ...
                 '青海卫视', '新疆卫视', '西藏卫视', '三沙卫视', '厦门卫视', '兵团卫视',  '农林卫视', '山东教育',
                 'CETV1', 'CETV2', 'CETV3', 'CETV4', '早期教育'],
    "专属频道": ['山西卫视', '黄河电视台', '山西影视', '山西经济与科技', '山西文体生活',
                 '山西社会与法治', 'BRTV文艺', 'BRTV影视', 'BRTV生活', '浙江卫视', '江苏卫视', '东方卫视', '深圳卫视', '北京卫视'],
...
CHANNEL_MAPPING = {
    ...
    "山西卫视": ["山西卫视", "山西卫视"],
    "黄河电视台": ["黄河电视台", "黄河电视"],
    "山西经济与科技": ["山西经济与科技", "山西经济与科技"],
    "山西影视": ["山西影视", "山西影视"],
    "山西社会与法治": ["山西社会与法治", "山西社会与法治"],
    "山西文体生活": ["山西文体生活"],
